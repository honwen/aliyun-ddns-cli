...
var ipAPI = []string{
	"https://v4.myip.la", "http://www.net.cn/static/customercare/yourip.asp", "http://ddns.oray.com/checkip", "http://haoip.cn",
...
var ip6API = []string{
	"http://speed.neu6.edu.cn/getIP.php", "https://v6.myip.la", "http://api-ipv6.ip.sb/ip", "http://ip6only.me/api/", "http://v6.ipv6-test.com/api/myip.php", "https://v6.ident.me",
}
